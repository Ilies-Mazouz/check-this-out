...
@section('content')
    <div class="space-y-8">
        <div class="rounded-tl-[2rem] rounded-tr-[2rem] rounded-br-[2rem] rounded-bl-md border p-8" style="background: color-mix(in srgb, var(--theme-surface) 94%, transparent); border-color: var(--theme-border); box-shadow: var(--theme-glow);">
            <p class="text-sm font-bold uppercase tracking-[0.35em]" style="color: var(--theme-muted);">Admin overview</p>
            <h2 class="mt-4 font-bold font-[Fredoka] text-5xl">Admin Dashboard</h2>
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
            @foreach ([
                ...
                <a href="{{ $card['route'] }}" class="block rounded-tl-[1.75rem] rounded-tr-[1.75rem] rounded-br-[1.75rem] rounded-bl-md border p-6 transition-all duration-300 hover:-translate-y-1" style="background: color-mix(in srgb, var(--theme-surface) 92%, transparent); border-color: var(--theme-border); box-shadow: var(--theme-glow);">
                    <p class="text-sm font-semibold uppercase tracking-[0.25em]" style="color: var(--theme-muted);">{{ $card['label'] }}</p>
                    <p class="mt-4 font-bold font-[Fredoka] text-5xl">{{ $card['value'] }}</p>
                </a>
            @endforeach
        </div>
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="rounded-tl-[1.75rem] rounded-tr-[1.75rem] rounded-br-[1.75rem] rounded-bl-md border p-6" style="background: color-mix(in srgb, var(--theme-surface) 92%, transparent); border-color: var(--theme-border); box-shadow: var(--theme-glow);">
                ...
                <p class="mt-2 font-bold font-[Fredoka] text-4xl">{{ $catalogueTotal }} <span class="text-base font-normal" style="color: var(--theme-muted); font-family: 'Space Grotesk', sans-serif;">titles</span></p>
            ...
            <div class="rounded-tl-[1.75rem] rounded-tr-[1.75rem] rounded-br-[1.75rem] rounded-bl-md border p-6" style="background: color-mix(in srgb, var(--theme-surface) 92%, transparent); border-color: var(--theme-border); box-shadow: var(--theme-glow);">
                ...
                <p class="mt-2 font-bold font-[Fredoka] text-4xl">{{ $newsTotal }} <span class="text-base font-normal" style="color: var(--theme-muted); font-family: 'Space Grotesk', sans-serif;">articles</span></p>
