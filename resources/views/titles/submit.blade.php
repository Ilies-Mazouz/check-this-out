...
@section('content')
    <div class="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <h1 class="mt-2 font-[Bebas_Neue] text-5xl uppercase tracking-[0.18em]">Submit a Title</h1>
        ...
        <form method="POST" action="{{ route('titles.submit.store') }}" enctype="multipart/form-data" class="mt-8 space-y-5 rounded-[1.75rem] border p-6 sm:p-8" style="background: color-mix(in srgb, var(--theme-surface) 94%, transparent); border-color: var(--theme-border); box-shadow: var(--theme-glow);">
